          ...
          return Scaffold(
            ...
            bottomNavigationBar: BoxButtonWidget(
                ...
                onPressed: () => model.onStartQuizTapped(
                    ...
                    lesson: lesson)).paddingSymmetric(horizontal: _.isTablet?kTabPaddingHorizontal:0),
            body: Column(
              children: [
                Text(
                  'text094'.tr,
                ...
                Expanded(
                  child: ListView.separated(
                      ...
                      itemCount: lesson.questions?.length ?? 0).paddingSymmetric(horizontal:!_.isTablet?0:kTabPaddingHorizontal),
                ),
              ],
            ),
          );
          ...
          return Column(
            children: [
              Text(
                ...
                style: kBodyStyle.copyWith(fontWeight: FontWeight.w500,fontSize: _.isTablet?24:16),
